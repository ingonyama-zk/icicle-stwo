...
impl PolyOps for SimdBackend {
    ...
    fn evaluate(
        ...
        for i in 0..(1 << log_subdomains) {
            ...
            // nvtx_timed!("[SIMD] calc subdomain twiddles");
