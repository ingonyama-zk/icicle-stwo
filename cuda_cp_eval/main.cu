...
void evaluate_constraint_quotients_on_domain(
    ...
    k_eval_row<<<component.execution_trace.n_rows / BLOCK_SIZE, BLOCK_SIZE>>>(
        ...
        component.execution_trace.n_cols,
...
int main() {
    ...
    readBinaryFile("/home/tonyw/scratch/stwo-playground/eval.bin", c.execution_trace.trace,
                   c.execution_trace.n_rows * c.execution_trace.n_cols);
    ...
    cudaMemPrefetchAsync(c.execution_trace.trace, c.execution_trace.n_rows * c.execution_trace.n_cols * sizeof(m31_t),
                         0);
